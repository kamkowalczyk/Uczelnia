...
%In Poland 2024
%Ile kosztuje 1 kWh Energa 2024?
%0,8585 zł/kWh brutto (cena zawiera 23% podatku od towarów i usług VAT i podatek akcyzowy).
cost = 0.8585/3.6e6;
...
tSecDay = 24*60*60;
tSecWeek = 7*tSecDay;
tSecMonth = 4.3*tSecWeek;
tSecYear = 52*tSecWeek;
...
tMaxStep = 15*60;    %[s]
tBegin = 0;         %[s]
%tBegin = 1*tSecMonth;         %[s]
tEnd = tSecWeek;       %[s]
%tEnd = tSecMonth;       %[s]
%tEnd = tBegin+2*tSecMonth;       %[s]
%tEnd = tSecYear;       %[s]
